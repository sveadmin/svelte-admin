...
describe('Test less than or equal validators', () => {
  ...
  it('Less than or equal validator works with injected runes', async () => {
    ...
    expect(validator2.validate({data: { valueFallback: 2}})).toEqual({valid: true, validatedValue: [2]})
    expect(validator3.validate({data: { valueFallback: 2}})).toEqual({valid: true, validatedValue: [2]})
  ...
  it('Less than or equal validator works for dates', async () => {
    ...
    expect(validator2.validate({data: {valueFallback: '2020-02-29'}})).toEqual({valid: true, validatedValue: [new Date('2020-02-29')]})
    expect(validator3.validate({data: {valueFallback: '2020-02-29'}})).toEqual({valid: true, validatedValue: [new Date('2020-02-29')]})
    expect(validator4.validate({data: {valueFallback: '2020-02-29'}})).toEqual({valid: true, validatedValue: [new Date('2020-02-29')]})
    expect(validator5.validate({data: {valueFallback: '2020-02-29'}})).toEqual({valid: true, validatedValue: [new Date('2020-02-29')]})
    expect(validator6.validate({data: {valueFallback: '2020-02-29'}})).toEqual({valid: true, validatedValue: [new Date('2020-02-29')]})

    expect(validator1.validate({data: {valueFallback: new Date('2020-02-29')}})).toEqual({valid: true, validatedValue: [new Date('2020-02-29')]})
    expect(validator2.validate({data: {valueFallback: new Date('2020-02-29')}})).toEqual({valid: true, validatedValue: [new Date('2020-02-29')]})
    expect(validator3.validate({data: {valueFallback: new Date('2020-02-29')}})).toEqual({valid: true, validatedValue: [new Date('2020-02-29')]})
    expect(validator4.validate({data: {valueFallback: new Date('2020-02-29')}})).toEqual({valid: true, validatedValue: [new Date('2020-02-29')]})
    expect(validator5.validate({data: {valueFallback: new Date('2020-02-29')}})).toEqual({valid: true, validatedValue: [new Date('2020-02-29')]})
    expect(validator6.validate({data: {valueFallback: new Date('2020-02-29')}})).toEqual({valid: true, validatedValue: [new Date('2020-02-29')]})
    ...
    expect(validator1.validate({data: {valueFallback: '2020-03-01T00:00:00Z'}})).toEqual({valid: true, validatedValue: [new Date('2020-03-01')]})
    expect(validator2.validate({data: {valueFallback: '2020-03-01T00:00:00Z'}})).toEqual({valid: true, validatedValue: [new Date('2020-03-01')]})
    expect(validator3.validate({data: {valueFallback: '2020-03-01T00:00:00Z'}})).toEqual({valid: true, validatedValue: [new Date('2020-03-01')]})
    expect(validator4.validate({data: {valueFallback: '2020-03-01T00:00:00Z'}})).toEqual({valid: true, validatedValue: [new Date('2020-03-01')]})
    expect(validator5.validate({data: {valueFallback: '2020-03-01T00:00:00Z'}})).toEqual({valid: true, validatedValue: [new Date('2020-03-01')]})
    expect(validator6.validate({data: {valueFallback: '2020-03-01T00:00:00Z'}})).toEqual({valid: true, validatedValue: [new Date('2020-03-01')]})

    expect(validator1.validate({data: {valueFallback: new Date('2020-03-01T00:00:00Z')}})).toEqual({valid: true, validatedValue: [new Date('2020-03-01')]})
    expect(validator2.validate({data: {valueFallback: new Date('2020-03-01T00:00:00Z')}})).toEqual({valid: true, validatedValue: [new Date('2020-03-01')]})
    expect(validator3.validate({data: {valueFallback: new Date('2020-03-01T00:00:00Z')}})).toEqual({valid: true, validatedValue: [new Date('2020-03-01')]})
    expect(validator4.validate({data: {valueFallback: new Date('2020-03-01T00:00:00Z')}})).toEqual({valid: true, validatedValue: [new Date('2020-03-01')]})
    expect(validator5.validate({data: {valueFallback: new Date('2020-03-01T00:00:00Z')}})).toEqual({valid: true, validatedValue: [new Date('2020-03-01')]})
    expect(validator6.validate({data: {valueFallback: new Date('2020-03-01T00:00:00Z')}})).toEqual({valid: true, validatedValue: [new Date('2020-03-01')]})
