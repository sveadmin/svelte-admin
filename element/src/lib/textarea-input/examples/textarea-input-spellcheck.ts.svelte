...
<GridLine>
  <span class="grid-span-4">Textarea with spellcheck</span>
  <span class="grid-span-8">
    <TextareaInput style="text-align: center;" spellcheck="true" value="<h1>This is a simple centered text !</h1><p>With another paragralph</p>" />
  </span>
</GridLine>
<GridLine>
